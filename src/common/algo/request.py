...
from common.tools.bdap_request import BDAPrequest_actual_command, BDAPGetError, BDAPRequestConfigurationError
...
class GetBDAPResource(TaylorRun):
    ...
    def execute(self, rh, opts):
        ...
        for input_query in input_queries:
            ...
            query_file = '/'.join([self.system.pwd(), input_query.rh.container.filename])
            ...
            with self.system.cdcontext(local_directory, create=True):
                ...
                logger.info(self.system.cat(query_file))
