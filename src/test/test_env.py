...
class UtEnv(TestCase):
    ...
    def setUp(self):
        self.res = Analysis(geometry=SpectralGeometry(), model='arpege', date='2011111700', cutoff='short', kind='analysis')
    ...
    def test_encoding(self):
        ...
        e['toto'] = self.res
        self.assertEqual(os.environ['TOTO'], '{"cutoff": "production", "kind": "analysis", "nativefmt": "fa", "geometry": {"area": null, "stretching": 2.3999999999999999, "resolution": null, "id": "abstract", "truncation": 798}, "filling": "full", "filtering": null, "date": "20111117000000", "clscontents": "DataRaw", "model": "arpege"}')
